//
//  EvolveRedPacketRainMsg.m
//  Runner
//
//  Created by FY0125 on 2023/10/11.
//

#import "EvolveRedPacketRainMsg.h"

@implementation EvolveRedPacketRainMsg
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRedPacketRainMsg *data = [EvolveRedPacketRainMsg new];
    if (data) {

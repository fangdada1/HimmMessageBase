#import "EvolvePKInfoFirstGiftMsg.h"

@implementation EvolvePKInfoFirstGiftMsg
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolvePKInfoFirstGiftMsg *data = [EvolvePKInfoFirstGiftMsg new];
    if (data) {

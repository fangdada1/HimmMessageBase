//
//  EvolveDuelInfoEndMessage.m
//  Runner
//
//  Created by himi on 11/08/23.
//

#import "EvolveDuelInfoEndMessage.h"

@implementation EvolveDuelInfoEndMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoEndMessage *facekData = [EvolveDuelInfoEndMessage new];
    if (facekData) {

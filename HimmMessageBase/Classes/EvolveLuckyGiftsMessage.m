//
//  EvolveLuckyGiftsMessage.m
//  Runner
//
//  Created by FY0125 on 2023/7/28.
//

#import "EvolveLuckyGiftsMessage.h"

@implementation EvolveLuckyGiftsMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveLuckyGiftsMessage *data = [EvolveLuckyGiftsMessage new];
    if (data) {

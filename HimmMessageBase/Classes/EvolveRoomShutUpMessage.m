//
//  EvolveRoomShutUpMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/9.
//

#import "EvolveRoomShutUpMessage.h"

@implementation EvolveRoomShutUpMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRoomShutUpMessage *data = [EvolveRoomShutUpMessage new];
    if (data) {

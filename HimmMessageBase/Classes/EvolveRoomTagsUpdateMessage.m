//
//  EvolveRoomTagsUpdateMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/12.
//

#import "EvolveRoomTagsUpdateMessage.h"

@implementation EvolveRoomTagsUpdateMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRoomTagsUpdateMessage *data = [EvolveRoomTagsUpdateMessage new];
    if (data) {

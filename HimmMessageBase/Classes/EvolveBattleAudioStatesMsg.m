//
//  EvolveBattleAudioStatesMsg.m
//  Runner
//
//  Created by FY0125 on 2023/10/21.
//

#import "EvolveBattleAudioStatesMsg.h"

@implementation EvolveBattleAudioStatesMsg
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveBattleAudioStatesMsg *data = [EvolveBattleAudioStatesMsg new];
    if (data) {

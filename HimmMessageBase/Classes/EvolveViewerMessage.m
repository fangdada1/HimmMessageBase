//
//  EvolveViewerMessage.m
//  Runner
//
//  Created by evolve on 24/07/23.
//

#import "EvolveViewerMessage.h"

@implementation EvolveViewerMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveViewerMessage *data = [EvolveViewerMessage new];
    if (data) {

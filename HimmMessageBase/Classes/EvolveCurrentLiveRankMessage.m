//
//  EvolveCurrentLiveRankMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/1.
//

#import "EvolveCurrentLiveRankMessage.h"

@implementation EvolveCurrentLiveRankMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveCurrentLiveRankMessage *data = [EvolveCurrentLiveRankMessage new];
    if (data) {

//
//  EvolveDuelInfoInviteMessage.m
//  Runner
//
//  Created by himi on 11/08/23.
//

#import "EvolveDuelInfoInviteMessage.h"

@implementation EvolveDuelInfoInviteMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoInviteMessage *facekData = [EvolveDuelInfoInviteMessage new];
    if (facekData) {

//
//  EvolveLiveCallChangeMessage.m
//  Runner
//
//  Created by fuya07 on 2024/8/12.
//

#import "EvolveLiveCallChangeMessage.h"

@implementation EvolveLiveCallChangeMessage
-(NSData *)encode {
...
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveLiveCallChangeMessage *joinData = [EvolveLiveCallChangeMessage new];
    if (joinData) {

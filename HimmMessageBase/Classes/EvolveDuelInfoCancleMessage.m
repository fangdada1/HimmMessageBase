//
//  EvolveDuelInfoCancleMessage.m
//  Runner
//
//  Created by himi on 11/08/23.
//

#import "EvolveDuelInfoCancleMessage.h"

@implementation EvolveDuelInfoCancleMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoCancleMessage *facekData = [EvolveDuelInfoCancleMessage new];
    if (facekData) {

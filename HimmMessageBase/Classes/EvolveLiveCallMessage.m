//
//  EvolveLiveCallMessage.m
//  Runner
//
//  Created by fuya07 on 2024/8/12.
//

#import "EvolveLiveCallMessage.h"

@implementation EvolveLiveCallMessage
-(NSData *)encode {
...
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveLiveCallMessage *joinData = [EvolveLiveCallMessage new];
    if (joinData) {

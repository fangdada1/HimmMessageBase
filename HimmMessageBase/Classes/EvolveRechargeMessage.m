//
//  EvolveRechargeMessage.m
//  Runner
//
//  Created by himm on 04/08/23.
//

#import "EvolveRechargeMessage.h"

@implementation EvolveRechargeMessage
...
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRechargeMessage *joinData = [EvolveRechargeMessage new];
    if (joinData) {

//
//  EvolveDiamondsCriticalMsg.m
//  Runner
//
//  Created by FY0125 on 2023/10/21.
//

#import "EvolveDiamondsCriticalMsg.h"

@implementation EvolveDiamondsCriticalMsg
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDiamondsCriticalMsg *data = [EvolveDiamondsCriticalMsg new];
    if (data) {

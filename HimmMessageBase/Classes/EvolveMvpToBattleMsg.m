//
//  EvolveMvpToBattleMsg.m
//  Runner
//
//  Created by FY0125 on 2023/10/21.
//

#import "EvolveMvpToBattleMsg.h"

@implementation EvolveMvpToBattleMsg
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveMvpToBattleMsg *data = [EvolveMvpToBattleMsg new];
    if (data) {

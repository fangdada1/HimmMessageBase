//
//  EvolveAllRoomGiftsWinMessage.m
//  Runner
//
//  Created by FY0125 on 2023/8/15.
//

#import "EvolveAllRoomGiftsWinMessage.h"

@implementation EvolveAllRoomGiftsWinMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveAllRoomGiftsWinMessage *data = [EvolveAllRoomGiftsWinMessage new];
    if (data) {

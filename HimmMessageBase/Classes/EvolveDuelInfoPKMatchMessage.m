//
//  EvolveDuelInfoPKMatchMessage.m
//  Runner
//
//  Created by himi on 16/08/23.
//

#import "EvolveDuelInfoPKMatchMessage.h"

@implementation EvolveDuelInfoPKMatchMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoPKMatchMessage *data = [EvolveDuelInfoPKMatchMessage new];
    if (data) {

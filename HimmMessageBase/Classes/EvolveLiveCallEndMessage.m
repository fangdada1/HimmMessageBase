//
//  EvolveLiveCallEndMessage.m
//  Runner
//
//  Created by fuya07 on 2024/8/12.
//

#import "EvolveLiveCallEndMessage.h"

@implementation EvolveLiveCallEndMessage
...
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveLiveCallEndMessage *joinData = [EvolveLiveCallEndMessage new];
    if (joinData) {

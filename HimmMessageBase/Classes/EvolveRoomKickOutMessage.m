//
//  EvolveRoomKickOutMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/15.
//

#import "EvolveRoomKickOutMessage.h"

@implementation EvolveRoomKickOutMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRoomKickOutMessage *data = [EvolveRoomKickOutMessage new];
    if (data) {

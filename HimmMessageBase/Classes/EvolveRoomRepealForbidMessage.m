//
//  EvolveRoomRepealForbidMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/15.
//

#import "EvolveRoomRepealForbidMessage.h"

@implementation EvolveRoomRepealForbidMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRoomRepealForbidMessage *data = [EvolveRoomRepealForbidMessage new];
    if (data) {

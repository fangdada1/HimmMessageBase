//
//  EvolveStartLookRankMessage.m
//  Runner
//
//  Created by fuya07 on 2024/8/12.
//

#import "EvolveStartLookRankMessage.h"

@implementation EvolveStartLookRankMessage
-(NSData *)encode {
...
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveStartLookRankMessage *joinData = [EvolveStartLookRankMessage new];
    if (joinData) {

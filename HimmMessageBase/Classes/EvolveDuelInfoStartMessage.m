//
//  EvolveDuelInfoStartMessage.m
//  Runner
//
//  Created by himi on 11/08/23.
//

#import "EvolveDuelInfoStartMessage.h"

@implementation EvolveDuelInfoStartMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoStartMessage *facekData = [EvolveDuelInfoStartMessage new];
    if (facekData) {

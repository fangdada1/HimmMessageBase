//
//  EvolveDuelInfoRejectMessage.m
//  Runner
//
//  Created by himi on 11/08/23.
//

#import "EvolveDuelInfoRejectMessage.h"

@implementation EvolveDuelInfoRejectMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelInfoRejectMessage *facekData = [EvolveDuelInfoRejectMessage new];
    if (facekData) {

//
//  EvolveDuelDiamondChangeMessage.m
//  Runner
//
//  Created by himm on 11/08/23.
//

#import "EvolveDuelDiamondChangeMessage.h"

@implementation EvolveDuelDiamondChangeMessage

+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveDuelDiamondChangeMessage *facekData = [EvolveDuelDiamondChangeMessage new];
    if (facekData) {

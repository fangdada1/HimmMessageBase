//
//  EvolveRoomSetAdminMessage.m
//  Runner
//
//  Created by FY0125 on 2024/8/14.
//

#import "EvolveRoomSetAdminMessage.h"

@implementation EvolveRoomSetAdminMessage
+ (instancetype)messageWithContent:(NSString *)jsonContent {
    EvolveRoomSetAdminMessage *data = [EvolveRoomSetAdminMessage new];
    if (data) {
